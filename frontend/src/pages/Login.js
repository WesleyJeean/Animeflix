...
function Login() {
  ...
  const handleEmailLogin = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.post(`${API_URL}/api/auth/login`, loginData, { withCredentials: true });
  ...
  const handleSignup = async (e) => {
    ...
    setLoading(true);
    try {
      await axios.post(`${API_URL}/api/auth/signup`, signupData, { withCredentials: true });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-zinc-900 to-black p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-5xl font-black tracking-tighter text-white mb-2" style={{fontFamily: 'Outfit'}}>AnimeFlix</h1>
          <p className="text-muted-foreground">Stream unlimited anime</p>
        </div>

        <Card className="bg-black/50 backdrop-blur-xl border-white/10" data-testid="login-card">
          <CardHeader>
